...
def send_2sa_notification(
        username, smtp_email, smtp_password, smtp_host, smtp_port, smtp_no_tls, to_addr
):
    """Send an email notification when 2SA is expired"""
...
Two-step authentication has expired for {username}.
Please log in to your server and run the script manually leaving out --smtp-username to update two-step authentication."""
